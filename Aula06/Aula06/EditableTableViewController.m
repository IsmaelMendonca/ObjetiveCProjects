...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.textLabel setText:[NSString stringWithFormat: @"%@ - %ld", self.nomes[indexPath.row], indexPath.row]];
    
//    UILabel *label = [[UILabel alloc] init];
//    
//    [label setText:[NSString stringWithFormat:@"Meu teste %ld", indexPath.row]];
//    
//    [label sizeToFit];
//    
